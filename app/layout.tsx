...
import "./klym-balanced-home.css";
import "./klym-premium-v2.css";
      ...
      <body>
        ...
        <footer className="site-footer shop-footer">
          <div className="footer-grid">
            <div className="footer-brand"><Logo /><p>Specialist XSTO powered mobility, sold and supported in the UK.</p><Link className="shop-button primary compact" href="/#models">Shop XSTO</Link></div>
            <div className="footer-col"><h4>Shop</h4><Link href="/xsto-m4">M4</Link><Link href="/xsto-m4b">M4B</Link><Link href="/xsto-m4-pro">M4 Pro</Link><Link href="/xsto-x12">X12</Link><Link href="/xsto-x12-pro">X12 Pro</Link></div>

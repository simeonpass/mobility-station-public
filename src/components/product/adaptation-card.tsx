...
export function AdaptationCard({ product }: { product: ProductListItem }) {
  ...
  return <Link href={`/products/${product.slug}`} className="ms-clean-adaptation-card group flex h-full flex-col overflow-hidden rounded-2xl border border-border bg-white transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-[0_18px_40px_-28px_rgba(0,0,0,0.3)]">

...
export function BranchMap({ branches }: { branches: Branch[] }) {
  ...
  return (
    <section ref={rootRef} className="bg-soft/55 py-14 md:py-20">
      <div className="container-site">
        <p className="text-xs font-bold uppercase tracking-[0.16em] text-muted">
          Visit Mobility Station
        </p>
        <h2 className="mt-2 text-3xl font-extrabold tracking-tight text-primary md:text-4xl">
          Heathrow &amp; Ferndown.
        </h2>
        <p className="mt-3 max-w-2xl text-muted">
          Two specialist branches — or home demonstrations where suitable.
        </p>
        <div className="relative z-0 mt-9 isolate overflow-hidden rounded-[2rem] border border-border bg-white">

  ...
  return (
    <div className={styles.gallery}>
      <div className={styles.collage}>
        <div className={`${styles.scene} ${styles.featured}`}>
          <div className={styles.frame}>
            <HomeHeroVideo />
          </div>
          <Link className={styles.label} href="/vehicle-adaptations/mechanical-hand-controls">
            Drive with confidence<ArrowUpRight size={17} aria-hidden="true" />
          </Link>
        </div>
        {scenes.map((scene) => (
          <Link

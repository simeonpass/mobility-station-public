...
export function SiteFooter() {
  return <footer className="ms-footer">
    <div className="container-site ms-footer-grid">
      <div><BrandLogo /><p>Vehicle adaptations. Everyday mobility.<br />More possibilities.</p><a className="ms-footer-call" href={SITE.phoneHref}>{SITE.phone}</a><a href={`mailto:${SITE.email}`}>{SITE.email}</a></div>
      ...
      <div><h3>Come and see us</h3><Link href="/locations"><strong>Heathrow</strong><br />1–2 Horton Close<br />West Drayton, UB7 8EB</Link><Link href="/locations"><strong>Ferndown</strong><br />2 Old Forge Road<br />Wimborne, BH21 7RR</Link></div>
    </div>

...
export function SiteFooter() {
  return <footer className="ms-footer">
    <div className="container-site ms-footer-grid">
      <div><BrandLogo tone="badge" /><p>Vehicle adaptations. Everyday mobility.<br />More possibilities.</p><a className="ms-footer-call" href={SITE.phoneHref}>{SITE.phone}</a><a href={`mailto:${SITE.email}`}>{SITE.email}</a></div>

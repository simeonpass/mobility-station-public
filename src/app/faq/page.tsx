...
export default async function FaqPage() {
  ...
  return <>
    ...
    <CatalogIntro breadcrumb="FAQs" eyebrow="A little guidance goes a long way" title="Questions, clearly answered." subtitle="Practical answers about demonstrations, Motability, VAT relief, vehicle adaptations and mobility equipment." />
